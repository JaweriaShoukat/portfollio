                ...
                <div className="extra_metas">
                    <ul className="flex flex-wrap md:gap-3">
                        ...
                        <li className="before:content-['/'] before:text-neutral-500 dark:before:text-white relative">
                            <span className="text-base text-neutral-500 dark:text-white pl-3"><Link href='#'>Branding</Link></span>
                        </li>
                        <li className="before:content-['/'] before:text-neutral-500 dark:before:text-white relative">
                            <span className="text-base text-neutral-500 dark:text-white pl-3"><Link href='#'>0 Comments</Link></span>
                        </li>
                    </ul>
                </div>
                <div className="post_title">
                    <h3 className="md:text-2xl text-xl font-semibold hover:underline underline-offset-4"><Link href='#'>{props.title}</Link></h3>
                </div>
            </div>
