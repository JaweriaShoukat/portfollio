    ...
    render() {
        ...
        return (
            <div>
                <Slider {...settings}>
                    <Single_tes
                        content={`"I was thoroughly impressed by Jaweria's UI/UX design skills. The websites in the portfolio are not just functional but also incredibly engaging."`} />
                    <Single_tes
                        content={`"Jaweria's proficiency in HTML/CSS shines through in the portfolio. The code is clean, well-structured, and sets a high standard for web development."`} />
                    <Single_tes
                        content={`"I was thoroughly impressed by Jaweria's UI/UX design skills. The websites in the portfolio are not just functional but also incredibly engaging."`} />
                    <Single_tes
                        content={`"I was thoroughly impressed by Jaweria's UI/UX design skills. The websites in the portfolio are not just functional but also incredibly engaging."`} />
...
function Single_tes({name, position, content}) {
    return (
        <div>
