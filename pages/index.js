  ...
  return (<>
    ...
    <motion.div
      ...
      <motion.div id="home" className="md:pl-12 pl-4"
        ...
        <div className="">
          <Link href='#'>
            <a className="px-8 py-4 bg-neutral-700 dark:bg-blue-900/30 text-white border-2 border-transparent hover:bg-transparent dark:hover:bg-transparent hover:border-neutral-700 dark:hover:border-blue-900/30 text-base font-medium">Learn More</a>
          </Link>
        </div>
      </motion.div>
    </motion.div>
